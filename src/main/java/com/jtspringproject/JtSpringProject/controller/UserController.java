...
public class UserController {
	...
	@GetMapping("/buy")
	public String buy() {
		// There was never a buy.jsp - the cart page is the real checkout entry point.
	...
	public ModelAndView indexPage() {
		...
		mView.addObject("username", authentication != null ? authentication.getName() : "");
	...
	public String profileDisplay(Model model) {
		...
		if (authentication == null) {
			model.addAttribute("msg", "Please log in to view your profile.");
